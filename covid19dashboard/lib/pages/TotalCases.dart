                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text("Total Cases", style: TextStyle(color: const Color(0xffFFFFFF),fontWeight: FontWeight.bold,fontSize: 20),),
                        ),
                        FutureBuilder <Welcome>(
                            future: _covidData,
                            builder: (context, snapshot) {
                              if(snapshot.hasData){
                                dataValue = snapshot.data!.data.localTotalCases;
                                return Padding(
